...
export default class EditarClienteTitular extends Processo {
    ...
    constructor() {
        ...
        Armazem.InstanciaUnica.Clientes.forEach((cliente, index) => {
            if (!cliente.Titular) { // Only list "Titular" clients
                console.log(`${index + 1}: ${cliente.Nome}`);
            }
        });
        let indexCliente = this.entrada.receberNumero('Selecione um Cliente Titular para editar') - 1;
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 4:
                    ...
                    let cadastroEndereco = new CadastroEnderecoTitular(this.cliente);
